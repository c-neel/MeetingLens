        ...
        {isRegister ? (
          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              <button type="button" style={{ width: '100%', backgroundColor: 'white', border: '1px solid #e2e8f0', color: '#0f172a', fontSize: '14px', fontWeight: 500, padding: '10px', borderRadius: '0.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', cursor: 'pointer', transition: 'background-color 0.2s' }}>
